...
# Custom imports from Singularity
...
# Setting singularity db url as the default connection for alembic
config.set_main_option("sqlalchemy.url", settings.SINGULARITY_DB_CONNECTION_URL)
