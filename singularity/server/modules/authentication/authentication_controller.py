...
from singularity.database.repositories.rbac.user_repository import read_user_from_email
...
def login_with_username_and_password(
    ...
    user = read_user_from_email(session=session, user_email=user_login.username)
